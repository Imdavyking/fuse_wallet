...
import 'package:alan/proto/ethermint/types/v1/account.pb.dart';
...
class EthereumAccount extends AccountI {
  ...
  EthereumAccount(this.account);

  static EthereumAccount fromAny(Any any) {
    final account = EthAccount.fromBuffer(any.value);
