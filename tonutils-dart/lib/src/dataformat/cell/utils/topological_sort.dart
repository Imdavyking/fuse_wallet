...
List<TopologicalSortInt> topologicalSort(Cell src) {
  var pending = <Cell>[src];
  var allCells = <String, TopologicalSortString>{};
  ...
  while (pending.isNotEmpty) {
    ...
    for (var i = 0; i < cells.length; i += 1) {
      ...
      allCells[hash] = TopologicalSortString(
        cell: cells[i],
