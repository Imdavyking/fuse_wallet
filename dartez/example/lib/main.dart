...
class _MyAppState extends State<MyApp> {
  tezosWalletUtil() async {
    ...
    KeyStoreModel keys = await Dartez.getKeysFromMnemonic(
      mnemonic: mnemonic,
    );
    print("keys ===> $keys");
    ...
    KeyStoreModel identity = await Dartez.getKeysFromMnemonicAndPassphrase(
    ...
    faucetKeyStore
      ..publicKey = unloackedIdentityKeys.publicKey
      ..secretKey = unloackedIdentityKeys.secretKey
      ..publicKeyHash = unloackedIdentityKeys.publicKeyHash;
