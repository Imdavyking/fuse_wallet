...
class TxSigner {
  ...
  Future<Tx> createAndSign(
    ...
    var walletPubKey = wallet.publicKey;

    var pubKey = account.pubKey;
    if (pubKey.value.isNotEmpty != true) {
      final secp256Key = secp256.PubKey.create()..key = walletPubKey;
    ...
    // Sign those bytes
    final sigBytes = wallet.sign(Uint8List.fromList(bytesToSign), isEthSecp256);
