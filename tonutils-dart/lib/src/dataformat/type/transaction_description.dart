...
abstract class TransactionDescription {
  /// 0x00
...
void Function(Builder builder) storeTransactionDescription(
  ...
  return (Builder builder) {
    ...
    } else if (src is TdMergePrepare || src is TdMergeInstall) {
